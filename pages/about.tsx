...
export default function About({ workTimeline }) {
  ...
  return (
    <Container title="About Me - Ashwin Shenolikar">
      ...
      <p>
        I’m Ashwin, a software developer, newbie open source contributor, and
        hobbyist game developer. My mission is to be cautiously curious and
        never stop learning while developing meaningful, efficient and
        pixel-perfect products, that satisfy my customer's needs as much as they
      ...
      <p>
        ...
        I have recently graduated from Virginia Tech's Master's in Engineering
        course, with a dual focus in Software Development and Machine Learning.
        Over the 6 years of my academic journey in the world of Computer
        Science, I worked with and learned modern software development
        techniques and actually implemented projects using current industry
        software development model and frameworks, this website being a great
        example of one of my React.js projects.
      </p>
      <div>
        ...
        <p>
          During my Master's, I have worked as a Graduate Assistant at the
          upcoming Virginia Tech Innovation Campus, and have been instrumental
          in a lot of the projects and events during my employment.
        </p>
        <p>
          Prior to coming to the USA for my Master's, I was doing my Bachelor's
          in Computer Science and Engineering in the University of Mumbai's A.P.
          Shah Institute of Technology, where I helped my institute's nascent
          department grow considerably by organizing technical and non-technical
          events, also assisting my department with securing a national level
          accreditation for education quality.
        </p>
        {/*<p>*/}
        ...
        {/*</p>*/}
        <p>
          Apart from my academic pursuits, I enjoy going on treks, reading,
          learning new languages and instruments(Spanish and Guitar as of now),
          gaming, and going for badminton and/or cricket in my free time.
        </p>
        <p>
          You can find me on <a href={siteMetadata.linkedin}>LinkedIn</a> where
          I am rather active, or you can follow me on{' '}
          <CustomLink href={siteMetadata.github}>GitHub</CustomLink> to check
          out my latest contributions and projects!
        </p>
        <div></div>
      </div>
...
export const getStaticProps: GetStaticProps = async () => {
  const workTimeline = [
    ...
    },
    {
      ...
      duration: '',
      description:
        'Created an embedded system with onboard web server to control multiple HVAC systems improving energy usage by 14%.\n' +
    ...
    },
    {
      ...
      duration: '',
      description:
        'Worked as a graduate student assistant for the Virginia Tech Innovation Campus HQ, directly under the Administrative Head, \n' +
    ...
    },
    {
      ...
      duration: '',
      description:
        'Worked as a core council member for the computer science department of my undergraduate college, being actively involved in departmental activities and practices, \n' +
